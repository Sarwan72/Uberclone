  ...
  return (
    <div>
      ...
      // ref={panelRef}
        ...
        <h3  className="text-2xl font-semibold mb-5">New Ride is available!</h3>
        <div className='flex items-center rounded-2xl bg-amber-400 justify-between p-3'>
            ...
            <h5 className='text-lg font-semibold'>₹170</h5>
        </div>
        ...
        <div className='flex gap-5 justify-between flex-col items-center'>
            ...
            }} className=' bg-gray-400  p-3 px-10 rounded-lg text-gray-700 font-semibold'>Ignore</button>
             <button onClick={()=>{
                props.setConfirmRidePopUpPanel(true)
                props.confirmRide()
               
            }} className='w-full bg-green-700 p-3 px-10 rounded-lg  text-white font-semibold'>Accept</button>
